...
def test_add_contact_in_book_address(app):
    ...
    app.manager.user_data(User_basic_data(firstname="Lukasz", middlename="Ebi", lastname="Blaszkowski", nickname="lblaszkowski"))
    app.manager.adding_a_picture_and_name( User_picture(title_photo="Chomik"))
